...
v0 = [1.0, 2.0, 3.0]
rho = 0.5
print("hfun =",hfun(v0, rho))
print("rootsearch_bn =",rootsearch_bn(hfun, v0, 0.0, 1.0, 0.5))
print("rootsearch_ntinc =",rootsearch_ntinc(hfun, v0, 0.0, 1.0, 0.5))
print("projheu_primalexpcone =",projheu_primalexpcone(v0))
print("projheu_polarexpcone =", projheu_polarexpcone(v0))
print("projsol_primalexpcone =",projsol_primalexpcone(v0, rho))
print("projsol_polarexpcone =",projsol_polarexpcone(v0, rho))
print("ppsi =", ppsi(v0))
print("pomega =", pomega(rho))
print("dpsi =", dpsi(v0))
print("domega =",domega(rho))
print("searchbracket =", searchbracket(v0, 0.5, 0.5))
